...
const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { name: 'Properties', icon: Building2, href: '/app/properties' },
      { name: 'Tenants', icon: Users, href: '/app/tenants' },
      { name: 'Leases', icon: FileText, href: '/app/leases' },
    ]
  },
  {
    label: 'Operations',
    items: [
      { name: 'Maintenance', icon: Wrench, href: '/app/maintenance' },
      { name: 'Payments', icon: CreditCard, href: '/app/payments' },
      { name: 'Accounting', icon: Calculator, href: '/app/accounting' },
    ]
  },
  {
    label: 'Reference',
    items: [
      { name: 'Documents', icon: Files, href: '/app/documents' },
  ...
  },
  {
    label: 'System',
    items: [
      { name: 'Users', icon: UserCog, href: '/app/users' },
