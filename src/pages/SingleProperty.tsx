      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
            <button className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-card border rounded-lg text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors shadow-sm">
             ...
             <button className="p-2 bg-white dark:bg-card border rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors shadow-sm text-muted-foreground">
               ...
               <div className="bg-card border rounded-xl overflow-hidden shadow-sm p-6">
                   <div className="flex items-center justify-between mb-6">
                       ...
                       <div className="flex gap-2 text-sm bg-slate-100 dark:bg-slate-800 p-1 rounded-lg">
                           <button className="px-3 py-1 bg-white dark:bg-card shadow-sm rounded-md font-medium text-xs">MTD</button>
                           <button className="px-3 py-1 text-muted-foreground hover:text-foreground rounded-md transition-colors text-xs">YTD</button>
                       </div>
                   </div>
                   ...
                   <div className="mt-8 flex items-end gap-2 h-24 w-full">
                       {[60, 45, 70, 50, 80, 75, 65, 55, 85, 90, 80, 70].map((h, i) => (
                           <div key={i} className="flex-1 bg-emerald-100 dark:bg-emerald-900/20 rounded-t-sm relative group">
                               <div 
                                    className="absolute bottom-0 inset-x-0 bg-emerald-500 rounded-t-sm transition-all duration-500" 
                                    style={{ height: `${h}%` }} 
                               />
                           </div>
                       ))}
